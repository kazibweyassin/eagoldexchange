...
export const metadata = constructMetadata({
  title: "Trading Fees – East African Gold Exchange",
  description: "Transparent pricing for gold trading services. Connect with verified suppliers and buyers with competitive transaction fees.",
});
